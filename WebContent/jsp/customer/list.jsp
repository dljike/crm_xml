...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/customer/customerList.action" method=post>	
										...
										<TABLE id=grid style="BORDER-TOP-WIDTH: 0px; FONT-WEIGHT: normal; BORDER-LEFT-WIDTH: 0px; BORDER-LEFT-COLOR: #cccccc; BORDER-BOTTOM-WIDTH: 0px; BORDER-BOTTOM-COLOR: #cccccc; WIDTH: 100%; BORDER-TOP-COLOR: #cccccc; FONT-STYLE: normal; BACKGROUND-COLOR: #cccccc; BORDER-RIGHT-WIDTH: 0px; TEXT-DECORATION: none; BORDER-RIGHT-COLOR: #cccccc" cellSpacing=1 cellPadding=2 rules=all border=0>
											...
											<%-- 	<c:forEach items="${pb.datas}" var="customer">
												<TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													...
													<TD>
													<a href="${pageContext.request.contextPath }/customer/findPageCustomer&cust_id=${customer.cust_id}">修改</a>
													&nbsp;&nbsp;
												...
												<s:iterator value="pb.datas">
													...
													<TD>
													<a href="${pageContext.request.contextPath }/customer/findCustomerById.action?cust_id=<s:property value="cust_id"/>">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/customer/deleteCustomer.action?cust_id=<s:property value="cust_id"/>">删除</a>
													</TD>  
												</TR>
												</s:iterator>
